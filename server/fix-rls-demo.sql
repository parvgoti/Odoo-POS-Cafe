...
DROP POLICY IF EXISTS "Anon can read payment_methods" ON payment_methods;
...
DROP POLICY IF EXISTS "Anon can read sessions" ON pos_sessions;
...
DROP POLICY IF EXISTS "Anon can read kitchen_tickets" ON kitchen_tickets;
CREATE POLICY "Anon can read kitchen_tickets" ON kitchen_tickets FOR SELECT TO anon USING (true);

DROP POLICY IF EXISTS "Anon can read ticket_items" ON kitchen_ticket_items;
...
DROP POLICY IF EXISTS "Anon can manage order_items" ON order_items;
...
DROP POLICY IF EXISTS "Anon can manage kitchen_tickets" ON kitchen_tickets;
CREATE POLICY "Anon can manage kitchen_tickets" ON kitchen_tickets FOR ALL TO anon USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "Anon can manage ticket_items" ON kitchen_ticket_items;
